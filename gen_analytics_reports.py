...
# 1. Analytics.js
analytics_js = """// NLAMS AI Risk & Analytics Page Component
...
with open(os.path.join(pages_dir, "Analytics.js"), "w", encoding="utf-8") as f:
    f.write(analytics_js)

print("Written Analytics.js, Reports.js, Settings.js")
