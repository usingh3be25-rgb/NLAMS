...
# 1. RnR.js
rnr_js = """// NLAMS Rehabilitation & Resettlement (R&R) Page Component
...
with open(os.path.join(pages_dir, "RnR.js"), "w", encoding="utf-8") as f:
    f.write(rnr_js)

print("Written RnR.js and Possession.js")
