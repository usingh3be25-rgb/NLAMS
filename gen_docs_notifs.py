...
# 1. Documents.js
documents_js = """// NLAMS Document Management Page Component
...
with open(os.path.join(pages_dir, "Documents.js"), "w", encoding="utf-8") as f:
    f.write(documents_js)

print("Written Documents.js and Notifications.js")
